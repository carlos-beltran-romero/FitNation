...
var numeroSocioInput = document.getElementById("numeroSocio");
...
btnSiguiente1.addEventListener("click", function () {
    ...
    if(numeroSocioInput.value === ""){
        ...
        if (!esNumerico(numeroSocioInput)) {
            alert("Por favor, introduzca un número de socio válido");
            falloCampos = true;
        }
    }
    if(!falloCampos){
...
numeroSocioInput.addEventListener("input",function(){
    if (numeroSocioInput.value !== "") {
    ...
    sexoInput[0].disabled=true;
    sexoInput[1].disabled=true;
    telefonoInput.disabled=true;
        ...
        sexoInput[0].disabled=false;
        sexoInput[1].disabled=false;
